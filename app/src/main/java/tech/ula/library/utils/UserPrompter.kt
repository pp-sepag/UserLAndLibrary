...
class UserFeedbackPrompter(private val activity: MainActivity) : UserPrompter {
    ...
    override val initialPrompt: String
        get() = savedActivity.getString(R.string.review_is_user_enjoying, savedActivity.getString(R.string.app_name))
...
class CollectionOptInPrompter(private val activity: MainActivity) : UserPrompter {
    ...
    override val initialPrompt: String
        get() = savedActivity.getString(R.string.opt_in_help_prompt, savedActivity.getString(R.string.app_name))
    override val initialPosBtnText: Int
        get() = R.string.button_yes
    override val initialNegBtnText: Int
        get() = R.string.button_negative
...
class ContributionPrompter(private val activity: MainActivity) : UserPrompter {
    ...
    override val initialPrompt: String
        get() = savedActivity.getString(R.string.contribution_primary, savedActivity.getString(R.string.app_name))
    override val initialPosBtnText: Int
        get() = R.string.button_yes
    override val initialNegBtnText: Int
        get() = R.string.button_refuse
