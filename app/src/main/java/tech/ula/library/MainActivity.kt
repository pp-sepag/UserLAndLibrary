...
import tech.ula.library.model.state.*
    ...
    private fun handleStateUpdate(newState: State) {
        return when (newState) {
            ...
            is CanOnlyStartSingleSession -> {
                showToast(getString(R.string.single_session_supported, getString(R.string.app_name)))
    ...
    */
        ...
        return when (state) {
            ...
            is ActiveSessionsMustBeDeactivated -> {
                displayGenericErrorDialog(
                    ...
                    getString(R.string.deactivate_sessions)
                )
            }
        }
    }
    ...
    private fun handleIllegalState(state: IllegalState) {
        ...
        AlertDialog.Builder(this)
                ...
                .setTitle(getString(R.string.illegal_state_title,getString(R.string.app_name)))
    ...
    private fun showDialog(dialogType: String) {
        when (dialogType) {
            "unhandledSessionServiceType" -> {
                displayGenericErrorDialog(
                    R.string.general_error_title,
                    getString(R.string.illegal_state_unhandled_session_service_type)
                )
            }
            "playStoreMissingForClient" ->
                displayGenericErrorDialog(
                    R.string.alert_need_client_app_title,
                    getString(R.string.alert_need_client_app_message)
                )
        }
    }
    ...
    private fun displayLowStorageDialog() {
        displayGenericErrorDialog(
            ...
            getString(R.string.alert_storage_low_message, getString(R.string.app_name))
        ) {
